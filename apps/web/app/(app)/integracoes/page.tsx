...
/**
 * Integracoes com o Google.
 *
 * O Classroom precisa de escopos alem dos pedidos no login - eles sao
 * solicitados aqui, quando o usuario decide conectar, e nao na entrada.
 */
...
export default function IntegrationsPage() {
  return (
    <div className="mx-auto w-full max-w-3xl space-y-6 px-4 py-6 sm:px-6 lg:py-8">
      <div>
        <h1 className="text-xl font-semibold tracking-tight sm:text-2xl">Integrações</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Conecte suas contas para trazer dados automaticamente.
        </p>
      </div>
